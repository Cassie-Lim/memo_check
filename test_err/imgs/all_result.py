...
for level in levels:
    for corruption in corruptions:
        ...
        extra_err = np.load(
            file="/data/yusun/lmy/memo/cifar-10-exps/test_err/" +
            "extra_err_" + corruption + "_" + str(level) + ".npy")
        errs = np.concatenate((errs, extra_err.reshape(1, )))
...
for level in levels:
    ...
    plt.savefig(
        "/data/yusun/lmy/memo/cifar-10-exps/test_err/imgs/new-cifar10c-" +
        str(level) + ".png")

test_names = ["ResNet-26", "+SV", "+MEMO", "+MEMO,SV"]
